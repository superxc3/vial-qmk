...
# sofleplus2u: no trackpad_rdy_rst.c — GP13/GP14 are not wired to the IQS5xx on
# this batch and config.h does not define DIGITIZER_MOTION_PIN (see the RDY/RST
# note there). Timed polling at DIGITIZER_TASK_THROTTLE_MS instead.
