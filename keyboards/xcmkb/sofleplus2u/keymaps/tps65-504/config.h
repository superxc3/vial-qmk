...
// 100kHz), giving 11ms free for RGB vs only 5ms at the previous 10ms throttle.
...
#undef PRODUCT
#define PRODUCT "SoflePLUS2 v5.04 TPS65 Signature RGB Beta"



/* Vial UID for this specific keymap */
#ifdef VIAL_ENABLE
#define VIAL_KEYBOARD_UID {0xA2, 0x5E, 0xC8, 0x73, 0x1D, 0x94, 0x6F, 0x3B}
#endif
