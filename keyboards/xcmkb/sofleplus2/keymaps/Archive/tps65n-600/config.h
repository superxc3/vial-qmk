...
// GP13 (RDY) intentionally not used as DIGITIZER_MOTION_PIN: ~200us RDY race after END_COMMS
// causes stale/corrupt reads -> cursor skip. Confirmed empirically. Throttle-polling only.
...
#undef PRODUCT
#define PRODUCT "SoflePLUS2 North TPS65 v6.00 Beta"
