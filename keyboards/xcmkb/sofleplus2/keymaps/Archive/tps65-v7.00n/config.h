...
/* ============================================================
 * v7.00n PCB routing notes:
 * - IQS5xx has only SDA/SCL on the I2C bus — no dedicated RDY or RST pin.
 *   Polling mode (DIGITIZER_TASK_THROTTLE_MS) is used instead.
 * - GP25 is not connected to IQS5xx RDY; col6 is removed from the right
 *   side matrix scan to prevent driving a floating pin as output.
 * - GP12 is not connected to IQS5xx RST; no hardware reset needed.
 * - One firmware binary for both sides — no RIGHT_SIDE_BUILD needed.
 * ============================================================ */

/* Right side matrix: col6 (GP25) is floating on v7.00n — remove from scan. */
#define MATRIX_COL_PINS_RIGHT { GP27, GP26, GP22, GP20, GP23, GP21, NO_PIN }

/* No DIP switch on v7.00n right side. */
...
#undef PRODUCT
#define PRODUCT "SoflePLUS2 v7.00n TPS65"



/* Vial UID for this specific keymap */
#ifdef VIAL_ENABLE
#define VIAL_KEYBOARD_UID {0x5B, 0xE9, 0x17, 0xA4, 0x6C, 0x30, 0xD8, 0xF5}
#endif
