...
#define AZOTEQ_IQS5XX_ROTATION_180 /*for tps65*/
...
#undef PRODUCT
#define PRODUCT "SoflePLUS2 TPS65 Horizontal v5.07 Beta"



/* Vial UID for this specific keymap (unique — was still 507's UID after copy,
 * which made Vial unable to tell this board apart from tps65-507 when both
 * are connected at once) */
#ifdef VIAL_ENABLE
#define VIAL_KEYBOARD_UID {0x4F, 0x8B, 0x21, 0xD6, 0x73, 0xEA, 0x9C, 0x05}
#endif
