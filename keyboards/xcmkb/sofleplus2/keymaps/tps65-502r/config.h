...
#define EE_HANDS
#define INIT_EE_HANDS_RIGHT      // Auto-program EEPROM as RIGHT on every boot (survives EEPROM resets)
//#define MASTER_LEFT
//#define MASTER_RIGHT
...
#define I2C1_CLOCK_SPEED 100000   // 100kHz standard mode — 1MHz FM+ too fast for 100pF filter caps on SDA/SCL (C1546); rise time ≈1µs at 4.7kΩ pull-up


#define AZOTEQ_IQS5XX_TPS65
#define AZOTEQ_IQS5XX_REPORT_RATE 9
#define AZOTEQ_IQS5XX_ROTATION_270 /*for tps65*/
// DIGITIZER_MOTION_PIN: gate I2C reads on RDY pin (GP25, active-low) instead of polling every 10ms.
// Eliminates ~4ms blocking I2C read on every poll tick, preventing LED flicker on touch.
// Note: framework auto-undefines DIGITIZER_TASK_THROTTLE_MS when DIGITIZER_MOTION_PIN is set.
#define DIGITIZER_MOTION_PIN        GP25
...
#undef PRODUCT
#define PRODUCT "SoflePLUS2 v5.02r TPS65"



/* Vial UID for this specific keymap */
#ifdef VIAL_ENABLE
#define VIAL_KEYBOARD_UID {0x5C, 0xD7, 0x2E, 0x8B, 0x41, 0x93, 0xF6, 0x0A}
#endif
