...
#undef PRODUCT
#define PRODUCT "SoflePLUS2 TPS65 v5.10 Legendary"
 ...
 * 0x0289 TPS43), not per board, so a sofleplus2ano and a sofleplus2 both
 ...
 * (the encoder entries are swapped, as on the ano's tps65-504), so the two
 * layouts must not share a UID. */
#ifdef VIAL_ENABLE
#define VIAL_KEYBOARD_UID {0x51, 0x3A, 0xE9, 0x7D, 0x1C, 0xB6, 0x84, 0x2F}
#endif
