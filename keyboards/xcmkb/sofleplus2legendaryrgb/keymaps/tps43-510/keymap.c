...
// indicator roles corrupted each other (this is what this board's tps43-504 did).
...
static void print_tp_info_overlay(void) {
    ...
    if (g_tp_info_data.ptp_mode) {
        ...
        char s[4];
        snprintf(s, sizeof(s), "%d", g_tp_info_data.sniper_active
    ...
    /* Row 3: empty — visual breathing room */
}
