...
VIAL_KEYBOARD_UID = {0x3D,0xB5,0x72,0xE1,0x4F,0xA8,0x26,0xC9}
...
# sofleplus2legendaryrgb: no trackpad_rdy_rst.c — GP13/GP14 are the disc's DIP inputs on this
# board and config.h does not define DIGITIZER_MOTION_PIN (see the RDY/RST note
# there). Timed polling at DIGITIZER_TASK_THROTTLE_MS instead.
