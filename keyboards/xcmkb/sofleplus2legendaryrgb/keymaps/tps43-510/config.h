...
#undef PRODUCT
#define PRODUCT "SoflePLUS2 TPS43 v5.10 Legendary RGB"
 ...
 * sofleplus2legendaryrgb uses the same allocation (per keymap variant, not per
 * board), so a sofleplus2legendaryrgb and a sofleplus2 both flashed tps43-510 collide
...
/* Vial UID: SHARED with sofleplus2/tps43-510 on purpose. This keymap's vial.json is
...
#ifdef VIAL_ENABLE
#define VIAL_KEYBOARD_UID {0xD9, 0x42, 0x7A, 0x1C, 0xE8, 0x65, 0x30, 0xBF}
#endif