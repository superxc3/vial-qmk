...
#        define DIGITIZER_WIDTH_MM AZOTEQ_IQS5XX_HEIGHT_MM
#        define DIGITIZER_HEIGHT_MM AZOTEQ_IQS5XX_WIDTH_MM
#        define DIGITIZER_RESOLUTION_X AZOTEQ_IQS5XX_RESOLUTION_Y
#        define DIGITIZER_RESOLUTION_Y AZOTEQ_IQS5XX_RESOLUTION_X
#    else
