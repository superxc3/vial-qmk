...
static void azoteq_iqs5xx_digitizer_init(void) {
    azoteq_iqs5xx_init();
}
const digitizer_driver_t digitizer_driver = {.init = azoteq_iqs5xx_digitizer_init, .get_report = digitizer_driver_get_report};
